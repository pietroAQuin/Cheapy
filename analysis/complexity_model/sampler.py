...
This module works on the **raw** export line, not `data_models.Trajectory` — the prefix
...
from analysis.complexity_model.canonical import is_generated_item, to_canonical
from analysis.complexity_model.logged_action import action_run_at
from pre_processing.trajectory_analyzer import count_tokens
...
class Sample:
    ...
    label**, not a feature: `features.extract_step_features` must never read it (README §4
