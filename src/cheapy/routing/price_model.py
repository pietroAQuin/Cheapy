...
The crux, per docs/FULL_REPORT.md §5: providers cache the shared input prefix across a trajectory's
...
def _next_call_cost(trajectory: Trajectory, model: ModelLLM) -> float:
    ...
    if holding:
        ...
        # uncached, not just the increment. This is the cache trap from docs/FULL_REPORT.md §5.
        cached_tokens = 0.0
