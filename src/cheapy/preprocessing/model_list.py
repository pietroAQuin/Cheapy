...
None default: those fields are set later by src/cheapy/routing/performance_model.py
and src/cheapy/routing/price_model.py, respectively, as functions of
...
def build_model_list() -> list[ModelLLM]:
    ...
    src/cheapy/routing/performance_model.py and src/cheapy/routing/price_model.py);
