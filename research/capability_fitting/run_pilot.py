...
"""End-to-end driver for the offline pipeline — spec §9, as revised by the pivot.
    ...
    python -m research.capability_fitting.run_pilot --n 957 --fit
...
from research.capability_fitting.elicit import load_store, probe_temperatures, run_elicitation
from cheapy.capability.priors import PROBES
from research.capability_fitting.sampler import Sample, write_samples
from cheapy.preprocessing.model_list import price_for
...
def main() -> int:
    ...
    if args.fit:
        from research.capability_fitting.train import build_dataset, fit, save_artifact
