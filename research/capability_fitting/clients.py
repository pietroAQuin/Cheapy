...
from research.capability_fitting.canonical import CanonicalRequest, render_anthropic, render_openai
from research.capability_fitting.parser import ANTHROPIC_MODELS
...
#: figures — see `src/cheapy/preprocessing/model_list.py`'s `_MODEL_CONTEXT_WINDOWS` for sources.
CONTEXT_WINDOW = {
