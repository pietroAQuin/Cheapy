...
scores every measured ordered pair, and fits one pooled model.
    ...
    python -m research.capability_fitting.train \
        --samples research/capability_fitting/store/samples.jsonl \
        --responses research/capability_fitting/store/responses.jsonl
...
from research.capability_fitting.canonical import ToolDef, convert_tool
from research.capability_fitting.elicit import SELF_PAIR_SUFFIX, base_model_of, load_store
from cheapy.capability.features import (
    FEATURE_NAMES,
    PAIR_FEATURE_NAMES,
    extract_step_features,
    pair_descriptor,
)
from research.capability_fitting.logged_action import logged_action_for
from research.capability_fitting.parser import parse_response
from cheapy.capability.priors import BASE_CAPABILITY, CANDIDATES, PROBES
from research.capability_fitting.sampler import Sample
from research.capability_fitting.scoring import Action, pair as pair_score
